...
<head>
    ...
    <title>Plateforme de vente de produits agricole </title>
                            ...
                            <div class="row d-flex justify-content-between align-items-center">
                                ...
                                <div class="header-info-right">
                                    <ul>
                                        ...
                                        <li><a href="{{ route('produits.list') }}">Listes Produits </a></li>
                                        <li><a href="cart.html">Boutique</a></li>
                                        <li><a href="cart.html">Pannier</a></li>
                        ...
                        <div class="row align-items-center">
                                ...
                                <div class="main-menu f-right d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li class="hot"><a href="#">Nos Cultures</a>
                                                <ul class="submenu">
                                                    <li><a href="{{ route('produits.list') }}"> Product list</a></li>
                                            ...
                                            <li><a href="#">Pages</a>
                                                <ul class="submenu">
                                                    ...
                                                    <li><a href="cart.html">Pannier</a></li>
                                                    <li><a href="elements.html">Culture</a></li>
                            ...
                            <div class="col-xl-5 col-lg-3 col-md-3 col-sm-3 fix-card">
                                <ul class="header-right f-right d-none d-lg-block d-flex justify-content-between">
                                    ...
                                    <li class="d-none d-lg-block"> <a href="http://127.0.0.1:8000/login"
                        ...
                        <div class="row d-flex align-items-center justify-content-between">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 d-none d-md-block">
                                <div class="hero__img" data-animation="bounceIn" data-delay=".4s">
                                    <img src="storage/image/img-1.png" alt="">
                                </div>
                            </div>
                            <div class="col-xl-5 col-lg-5 col-md-5 col-sm-8">
                                <div class="hero__caption">
                                    <span data-animation="fadeInRight" data-delay=".4s">20% Reduction</span>
                                    <h2 data-animation="fadeInRight" data-delay=".6s">Découvrez</h2>
                                    <p data-animation="fadeInRight" data-delay=".8s">La meilleure sélection de
                                        fruits et légumes cultivés localement. Biologiques, durables et livrés avec
                                        soin. Goûtez le goût de la fraîcheur dès aujourd'hui !</p>
                                    <!-- Hero-btn -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4">
                        <div class="single-category mb-30">
                            <div class="category-img">
                                <img src="assets/img/farmer.png" alt="">
                                <div class="category-caption">
                                    <h2>Baga Farmer</h2>
                                    <span class="best"><a href="#">Choisissez le meileure</a></span>
                    ...
                    <div class="col-xl-4 col-lg-8">
                        <div class="single-category mb-30">
                            <div class="category-img">
                                <img src="storage/agriculture/fraise.jpg" alt="">
                                <div class="category-caption">
                                    <h2>Owmen`s</h2>
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <div class="row">
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="single-product mb-60">
                                    <div class="product-img">
                                        <img src="storage/agriculture/img-2.png" alt="">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="single-product mb-60">
                                    <div class="product-img">
                                        <img src="storage/agriculture/img-1.png" alt="">
                                    </div>
                                    <div class="product-caption">
                                        <div class="product-ratting">
                                            <i class="far fa-star"></i>
                    ...
                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="single-product mb-60">
                                    <div class="product-img">
                                        <img src="storage/agriculture/img-3.png" alt="">
                                    </div>
                                    <div class="product-caption">
                                        <div class="product-ratting">
                                            <i class="far fa-star"></i>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="single-product mb-60">
                                    <div class="product-img">
                                        <img src="storage/agriculture/img-5.png" alt="">
                                        <div class="new-product">
                                            <span>New</span>
                                        </div>
                                    </div>
